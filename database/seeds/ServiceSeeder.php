...
class ServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Добавим еще автозаполнение категорий и статусов для техподдержки
        DB::table('ticketit_categories')->insert([
            'name' => 'Проблемы с анкетами',
            'color' => '#000000',
        ]);

        DB::table('ticketit_categories')->insert([
        'name' => 'Проблемы с почтой',
        'color' => '#000000',
        ]);

        DB::table('ticketit_categories')->insert([
            'name' => 'Проблемы с аккаунтом',
            'color' => '#000000',
        ]);
