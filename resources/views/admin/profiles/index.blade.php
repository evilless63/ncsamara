...
<div class="row justify-content-center">
    <div class="col-md-12">
        ...
        <button class="btn btn-primary btn-block mt-2 admin-profile-choose" type="button" 
            data-target="#">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.profilemoderateallow', $profile->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('patch')
                                        <button class="btn btn-success" style="padding: 0px 7.5px;"
                                    ...
                                    @else
                                    <form action="{{ route('admin.profilemoderatedisallow', $profile->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('patch')
