            ...
            <div class="tab-content">
                <div id="panel1" class="tab-pane fadein active">
                    <div class="row mt-5">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-8">
                                <p>Вы можете отметить ваше местоположение на карте. В таком случае, всем пользователям
                                    сайта будет доступна эта информация</p>
                            </div>
                            <div class="col-md-4">
                                <div class="deleteImage btn btn-danger" onclick="removeMarker(event)">Удалить с карты
                                </div>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h4>Загрузка нового фото (для главной страницы сайта)</h4>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="hidden" autocomplete="OFF" name="item_images_verification" id="item_images_verification"
                                        placeholder="" class="form-control input-sm" required />
                                    <button type="button" class="btn btn-lg add-image-button" data-toggle="modal"
                                        data-target="#myModalItem_images_verification"><i class="fas fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
